...
class BSTree {
    private:
        Node *root; // root or top of the BST
        void preOrder(Node*) const; // overloaded helper function
        void postOrder(Node*) const; // overloaded helper function
        void inOrder(Node*) const; // overloaded helper function
        Node *min(Node*)const; //helper for remove
        Node *max(Node*)const; //helper for remove
        void remove(Node*, Node*, string); //recursive helper
    public:
        /* Constructors */
        /* Default constructor */
        BSTree();
        ...
        /* For all printing orders, each node should be displayed as follows:
           ...
           */
        void preOrder() const; // recursive call
        void postOrder() const; // recursive call
        void inOrder() const; // recursive call
};
